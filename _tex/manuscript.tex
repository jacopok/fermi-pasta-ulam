...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/cell-5-output-1.pdf}}

}

\caption{Matrix entries for potential \emph{V} of the problem.}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/cell-6-output-1.pdf}}

}

\caption{Matrix entries for the Discrete Sine Transform \emph{U}.}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/cell-7-output-1.pdf}}

}

\caption{Matrix entries for the diagonalized potential.}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{manuscript_files/figure-pdf/cell-8-output-1.pdf}}

}

\caption{Nonlinear spring response.}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{figure_1.png}}
