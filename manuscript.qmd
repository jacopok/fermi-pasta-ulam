...
```{python}
#| fig-cap: "Matrix entries for potential _V_ of the problem."
...
```{python}
#| fig-cap: "Matrix entries for the Discrete Sine Transform _U_."
...
```{python}
#| fig-cap: "Matrix entries for the diagonalized potential."
...
```{python}
#| fig-cap: "Nonlinear spring response."
